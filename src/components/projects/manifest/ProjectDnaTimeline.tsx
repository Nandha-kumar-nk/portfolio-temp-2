...
interface ProjectDnaTimelineProps {
  project: ProjectItem;
}
...
export const ProjectDnaTimeline: React.FC<ProjectDnaTimelineProps> = ({ project }) => {
    ...
    <div className="w-full max-w-4xl mx-auto my-12 px-4 select-none">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-1.5 mb-6">
        ...
        <h3 className="text-lg sm:text-xl font-bold tracking-tight text-white">
          Engineering Chronicles of <span className="text-cyan-400">{project.title}</span>
        </h3>
      </div>

      {/* Thin Timeline Line & Nodes */}
      ...
      <div className="relative w-full max-w-3xl mx-auto min-h-[160px]">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-3 pb-2.5 border-b border-slate-800">
              <div className="w-7 h-7 rounded-lg bg-cyan-950 border border-cyan-400/50 flex items-center justify-center text-cyan-300">
              ...
              <span className="text-xs font-mono text-cyan-400 font-bold tracking-widest uppercase">
                {activeStageConfig.number} • {activeStageConfig.label}
              </span>
            </div>
    ...
    case 'technology':
      return (
        <div className="space-y-3">
          <p className="text-slate-300">Tech Stack implemented:</p>
