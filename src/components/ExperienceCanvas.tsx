...
export function ExperienceCanvas({
  ...
  console.log('[DIAGNOSTIC] 1. ExperienceCanvas mounted. currentScene:', currentScene);
  ...
  return (
    ...
    >
      <Canvas
        ...
        dpr={quality.dpr}
        onCreated={({ gl, camera }) => {
          console.log('[DIAGNOSTIC] 3. R3F Canvas created successfully! Camera initial pos:', camera.position.toArray());
          const handleContextLost = (e: Event) => {
            console.error('[DIAGNOSTIC] 10. WEBGL CONTEXT LOST ON EXPERIENCE CANVAS!', e);
          };
